...
func (_q *AttachmentQuery) FirstID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (_q *AttachmentQuery) FirstIDX(ctx context.Context) int64 {
...
func (_q *AttachmentQuery) OnlyID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (_q *AttachmentQuery) OnlyIDX(ctx context.Context) int64 {
...
func (_q *AttachmentQuery) IDs(ctx context.Context) (ids []int64, err error) {
...
func (_q *AttachmentQuery) IDsX(ctx context.Context) []int64 {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *AttachmentQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(attachment.Table, attachment.Columns, sqlgraph.NewFieldSpec(attachment.FieldID, field.TypeInt64))
	_spec.From = _q.sql
