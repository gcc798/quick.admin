...
func (_q *CasbinRuleQuery) FirstID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (_q *CasbinRuleQuery) FirstIDX(ctx context.Context) int64 {
...
func (_q *CasbinRuleQuery) OnlyID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (_q *CasbinRuleQuery) OnlyIDX(ctx context.Context) int64 {
...
func (_q *CasbinRuleQuery) IDs(ctx context.Context) (ids []int64, err error) {
...
func (_q *CasbinRuleQuery) IDsX(ctx context.Context) []int64 {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *CasbinRuleQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(casbinrule.Table, casbinrule.Columns, sqlgraph.NewFieldSpec(casbinrule.FieldID, field.TypeInt64))
	_spec.From = _q.sql
