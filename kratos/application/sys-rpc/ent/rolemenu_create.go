...
func (_c *RoleMenuCreate) SetCreateBy(v int64) *RoleMenuCreate {
	_c.mutation.SetCreateBy(v)
	return _c
}

// SetNillableCreateBy sets the "create_by" field if the given value is not nil.
func (_c *RoleMenuCreate) SetNillableCreateBy(v *int64) *RoleMenuCreate {
	if v != nil {
		_c.SetCreateBy(*v)
	}
	return _c
...
func (_c *RoleMenuCreate) SetUpdateBy(v int64) *RoleMenuCreate {
	_c.mutation.SetUpdateBy(v)
	return _c
}

// SetNillableUpdateBy sets the "update_by" field if the given value is not nil.
func (_c *RoleMenuCreate) SetNillableUpdateBy(v *int64) *RoleMenuCreate {
	if v != nil {
		_c.SetUpdateBy(*v)
	}
	return _c
...
func (_c *RoleMenuCreate) SetCreatedTime(v time.Time) *RoleMenuCreate {
	_c.mutation.SetCreatedTime(v)
	return _c
}

// SetNillableCreatedTime sets the "created_time" field if the given value is not nil.
func (_c *RoleMenuCreate) SetNillableCreatedTime(v *time.Time) *RoleMenuCreate {
	if v != nil {
		_c.SetCreatedTime(*v)
	}
	return _c
...
func (_c *RoleMenuCreate) SetUpdatedTime(v time.Time) *RoleMenuCreate {
	_c.mutation.SetUpdatedTime(v)
	return _c
}

// SetNillableUpdatedTime sets the "updated_time" field if the given value is not nil.
func (_c *RoleMenuCreate) SetNillableUpdatedTime(v *time.Time) *RoleMenuCreate {
	if v != nil {
		_c.SetUpdatedTime(*v)
	}
	return _c
...
func (_c *RoleMenuCreate) SetRoleID(v int64) *RoleMenuCreate {
	_c.mutation.SetRoleID(v)
	return _c
}

// SetMenuID sets the "menu_id" field.
func (_c *RoleMenuCreate) SetMenuID(v int64) *RoleMenuCreate {
	_c.mutation.SetMenuID(v)
	return _c
}

// SetID sets the "id" field.
func (_c *RoleMenuCreate) SetID(v int64) *RoleMenuCreate {
	_c.mutation.SetID(v)
	return _c
}
...
func (_c *RoleMenuCreate) defaults() {
	if _, ok := _c.mutation.CreateBy(); !ok {
		v := rolemenu.DefaultCreateBy
		_c.mutation.SetCreateBy(v)
	}
	if _, ok := _c.mutation.UpdateBy(); !ok {
		v := rolemenu.DefaultUpdateBy
		_c.mutation.SetUpdateBy(v)
	}
	if _, ok := _c.mutation.CreatedTime(); !ok {
		v := rolemenu.DefaultCreatedTime()
		_c.mutation.SetCreatedTime(v)
	}
	if _, ok := _c.mutation.UpdatedTime(); !ok {
		v := rolemenu.DefaultUpdatedTime()
		_c.mutation.SetUpdatedTime(v)
	}
}
...
func (_c *RoleMenuCreate) check() error {
	if _, ok := _c.mutation.CreateBy(); !ok {
		return &ValidationError{Name: "create_by", err: errors.New(`ent: missing required field "RoleMenu.create_by"`)}
	}
	if _, ok := _c.mutation.UpdateBy(); !ok {
		return &ValidationError{Name: "update_by", err: errors.New(`ent: missing required field "RoleMenu.update_by"`)}
	}
	if _, ok := _c.mutation.CreatedTime(); !ok {
		return &ValidationError{Name: "created_time", err: errors.New(`ent: missing required field "RoleMenu.created_time"`)}
	}
	if _, ok := _c.mutation.UpdatedTime(); !ok {
		return &ValidationError{Name: "updated_time", err: errors.New(`ent: missing required field "RoleMenu.updated_time"`)}
	}
