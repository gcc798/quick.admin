...
// The HealthFunc type is an adapter to allow the use of ordinary
// function as Health mutator.
type HealthFunc func(context.Context, *ent.HealthMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f HealthFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.HealthMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.HealthMutation", m)
}
...
// The OperLogFunc type is an adapter to allow the use of ordinary
// function as OperLog mutator.
type OperLogFunc func(context.Context, *ent.OperLogMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f OperLogFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.OperLogMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.OperLogMutation", m)
}
...
// The StorageEnvFunc type is an adapter to allow the use of ordinary
// function as StorageEnv mutator.
type StorageEnvFunc func(context.Context, *ent.StorageEnvMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f StorageEnvFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.StorageEnvMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.StorageEnvMutation", m)
}
