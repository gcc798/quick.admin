...
const (
	HealthService_Ping_FullMethodName = "/api.system.v1.HealthService/Ping"
)
...
func (UnimplementedHealthServiceServer) Ping(context.Context, *PingRequest) (*PingReply, error) {
...
var HealthService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "api.system.v1.HealthService",
