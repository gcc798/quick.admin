...
func ApiPermissionUpdateHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.ApiPermissionUpdateReq
		...
		l := apipermission.NewApiPermissionUpdateLogic(ctx, svcCtx)
		resp, err := l.ApiPermissionUpdate(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
