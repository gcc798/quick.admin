...
func (l *RolePermissionAddLogic) RolePermissionAdd(req *types.RolePermissionReq) (resp *types.CommonResp, err error) {
	if _, err := l.svcCtx.SysRpcClient.RolePermissionAdd(l.ctx, &sysservice.RolePermissionReq{RoleKey: req.RoleKey, Resource: req.Resource, Action: req.Action}); err != nil { return &types.CommonResp{Code: 500, Msg: err.Error()}, nil }
