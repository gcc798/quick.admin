...
import (
	...
	sysserviceServer "github.com/gcc798/quick.admin/application/sys-rpc/internal/server/sysservice"
...
var configFile = flag.String("f", "etc/sys-rpc.yaml", "the config file")
